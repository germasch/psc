...
template <>
const MfieldsStateBase::Convert MfieldsStateFromMfields<Mfields<float>>::convert_to_;
extern template const MfieldsStateBase::Convert MfieldsStateFromMfields<Mfields<float>>::convert_to_;

template <>
const MfieldsStateBase::Convert MfieldsStateFromMfields<Mfields<float>>::convert_from_;
extern template const MfieldsStateBase::Convert MfieldsStateFromMfields<Mfields<float>>::convert_from_;

template <>
const MfieldsStateBase::Convert MfieldsStateFromMfields<Mfields<double>>::convert_to_;
extern template const MfieldsStateBase::Convert MfieldsStateFromMfields<Mfields<double>>::convert_to_;

template <>
const MfieldsStateBase::Convert MfieldsStateFromMfields<Mfields<double>>::convert_from_;
extern template const MfieldsStateBase::Convert MfieldsStateFromMfields<Mfields<double>>::convert_from_;
