...
static void __attribute__((format(printf, 1, 2))) error(const char* fmt, ...)
{
  va_list ap;
  va_start(ap, fmt);
...
static void __attribute__((format(printf, 1, 2))) warn(const char* fmt, ...)
{
  va_list ap;
  va_start(ap, fmt);
...
static struct option* find_option(const char* name, bool deprecated)
{
  struct option* p;
  __list_for_each_entry(p, &option_list, entry, struct option)
  {
    if (strcmp(p->name, name) == 0) {
      ...
      if (deprecated &&
        ...
        warn("option --%s is deprecated! You probably need to add a proper "
             "prefix.\n",
             name);
      }
      return p;
...
static int _mrc_params_get_option_int(const char* name, int* pval,
...
int mrc_params_get_option_int_help(const char* name, int* pval,
                                   const char* help)
{
  return _mrc_params_get_option_int(name, pval, false, help);
}

static int _mrc_params_get_option_uint(const char* name, unsigned int* pval,
                                       bool deprecated, const char* help)
{
  struct option* p = find_option(name, deprecated);
...
int mrc_params_get_option_uint_help(const char* name, unsigned int* pval,
                                    const char* help)
{
  return _mrc_params_get_option_uint(name, pval, false, help);
}

int _mrc_params_get_option_float(const char* name, float* pval, bool deprecated,
                                 const char* help)
{
  struct option* p = find_option(name, deprecated);
...
int mrc_params_get_option_float_help(const char* name, float* pval,
                                     const char* help)
{
  return _mrc_params_get_option_float(name, pval, false, help);
}

int _mrc_params_get_option_double(const char* name, double* pval,
                                  bool deprecated, const char* help)
{
  struct option* p = find_option(name, deprecated);
...
int mrc_params_get_option_double_help(const char* name, double* pval,
                                      const char* help)
{
  return _mrc_params_get_option_double(name, pval, false, help);
}

int _mrc_params_get_option_string(const char* name, const char** pval,
                                  bool deprecated, const char* help)
{
  struct option* p = find_option(name, deprecated);
  ...
  if (p) {
    *pval = p->value;
    ...
    // FIXME, *pval may not be initialized, in which case we'd crash trying to
    // print it we should disallow this use in the future.
    if (!deprecated) { // don't advertise deprecated un-prefixed options
...
int mrc_params_get_option_string_help(const char* name, const char** pval,
                                      const char* help)
{
  return _mrc_params_get_option_string(name, pval, false, help);
}

int _mrc_params_get_option_bool(const char* name, bool* pval, bool deprecated,
                                const char* help)
{
  struct option* p = find_option(name, deprecated);
    ...
    if (!p->value) { // just "--something"
      *pval = true;
      ...
      if (strcasecmp(p->value, "yes") == 0 ||
          strcasecmp(p->value, "true") == 0 || strcasecmp(p->value, "1") == 0) {
        *pval = true;
...
int mrc_params_get_option_bool_help(const char* name, bool* pval,
                                    const char* help)
{
  return _mrc_params_get_option_bool(name, pval, false, help);
}

int _mrc_params_get_option_select(const char* name,
                                  struct mrc_param_select* descr, int* pval,
                                  bool deprecated, const char* help)
{
  struct option* p = find_option(name, deprecated);
  if (p) {
    ...
    fprintf(stderr,
            "ERROR: Select value '%s' not found. Valid options are:", p->value);
    for (int i = 0; descr[i].str; i++) {
...
int mrc_params_get_option_select(const char* name,
                                 struct mrc_param_select* descr, int* pval)
{
  return _mrc_params_get_option_select(name, descr, pval, false, NULL);
}

int mrc_params_get_option_select_help(const char* name,
                                      struct mrc_param_select* descr, int* pval,
                                      const char* help)
{
...
int _mrc_params_get_option_int3(const char* name, int* pval, bool deprecated,
                                const char* help)
{
  int retval = -1;
...
int _mrc_params_get_option_int_array(const char* name,
                                     struct mrc_param_int_array* pval,
                                     bool deprecated, const char* help)
{
  struct option* p = find_option(name, deprecated);
  if (!p) {
    if (!deprecated) { // don't advertise deprecated un-prefixed options
      print_help("--%s: <%d> (default) %s...\n", name,
                 pval->vals ? pval->vals[0] : 0, help ? help : "");
    }
    return -1;
  }
...
int mrc_params_get_option_int3(const char* name, int* pval)
{
  return _mrc_params_get_option_int3(name, pval, false, NULL);
}

int mrc_params_get_option_int3_help(const char* name, int* pval,
                                    const char* help)
{
  return _mrc_params_get_option_int3(name, pval, false, help);
}

int mrc_params_get_option_int_array(const char* name,
                                    struct mrc_param_int_array* pval)
{
  return _mrc_params_get_option_int_array(name, pval, false, NULL);
}

int mrc_params_get_option_int_array_help(const char* name,
                                         struct mrc_param_int_array* pval,
                                         const char* help)
{
...
int _mrc_params_get_option_float3(const char* name, float* pval,
                                  bool deprecated, const char* help)
{
  int retval = -1;
  char namex[strlen(name) + 2];
...
int _mrc_params_get_option_float_array(const char* name,
                                       struct mrc_param_float_array* pval,
                                       bool deprecated, const char* help)
{
  struct option* p = find_option(name, deprecated);
  if (!p) {
    if (!deprecated) { // don't advertise deprecated un-prefixed options
      print_help("--%s: <%f> (default) %s...\n", name,
                 pval->vals ? pval->vals[0] : 0.0, help ? help : "");
    }
    return -1;
  }
...
int mrc_params_get_option_float_array(const char* name,
                                      struct mrc_param_float_array* pval)
{
  return _mrc_params_get_option_float_array(name, pval, false, NULL);
}

int mrc_params_get_option_float_array_help(const char* name,
                                           struct mrc_param_float_array* pval,
                                           const char* help)
{
...
int mrc_params_get_option_float3(const char* name, float* pval)
{
  return _mrc_params_get_option_float3(name, pval, false, NULL);
}

int mrc_params_get_option_float3_help(const char* name, float* pval,
                                      const char* help)
{
  return _mrc_params_get_option_float3(name, pval, false, help);
}

int _mrc_params_get_option_double3(const char* name, double* pval,
                                   bool deprecated, const char* help)
{
  int retval = -1;
  char namex[strlen(name) + 2];
...
int mrc_params_get_option_double3(const char* name, double* pval)
{
  return _mrc_params_get_option_double3(name, pval, false, NULL);
}

int mrc_params_get_option_double3_help(const char* name, double* pval,
                                       const char* help)
{
  return _mrc_params_get_option_double3(name, pval, false, help);
}

void mrc_params_get_option_ptr(const char* name, void** pval)
{
  assert(0);
}
...
void mrc_params_set_default(void* p, struct param* params)
{
  for (int i = 0; params[i].name; i++) {
    ...
    switch (params[i].type) {
      case PT_INT: pv->u_int = params[i].u.ini_int; break;
      case PT_UINT: pv->u_uint = params[i].u.ini_uint; break;
      case PT_BOOL: pv->u_bool = params[i].u.ini_bool; break;
      case PT_FLOAT: pv->u_float = params[i].u.ini_float; break;
      case PT_DOUBLE: pv->u_double = params[i].u.ini_double; break;
      case PT_STRING: pv->u_string = params[i].u.ini_string; break;
      case PT_SELECT: pv->u_select = params[i].u.select.default_value; break;
      case PT_INT3:
        for (int d = 0; d < 3; d++) {
      ...
      case PT_DOUBLE3:
        ...
        break;
      case PT_PTR: pv->u_ptr = params[i].u.ini_ptr; break;
      case PT_INT_ARRAY: {
      ...
      case PT_FLOAT_ARRAY: {
        ...
        if (pv->u_float_array.nr_vals == 0) {
          ...
          pv->u_float_array.vals =
            calloc(pv->u_float_array.nr_vals, sizeof(float));
        }
                        ...
                        int type, union param_u* pval)
{
  for (int i = 0; params[i].name; i++) {
    ...
    switch (type) {
      case PT_INT: pv->u_int = pval->u_int; break;
      case PT_UINT: pv->u_uint = pval->u_uint; break;
      case PT_FLOAT: pv->u_float = pval->u_float; break;
      case PT_DOUBLE: pv->u_double = pval->u_double; break;
      case PT_STRING: pv->u_string = pval->u_string; break;
      case PT_BOOL: pv->u_bool = pval->u_bool; break;
      case PT_SELECT: pv->u_select = pval->u_select; break;
      case PT_INT3:
      ...
      case PT_PTR: pv->u_ptr = pval->u_ptr; break;
      case PT_OBJ: pv->u_obj = pval->u_obj; break;
      default: assert(0);
    }
    return 0;
  }
                        ...
                        int type, union param_u* pval)
{
  for (int i = 0; params[i].name; i++) {
    ...
    switch (type) {
      case PT_BOOL: pval->u_bool = pv->u_bool; break;
      case PT_INT: pval->u_int = pv->u_int; break;
      case PT_UINT: pval->u_uint = pv->u_uint; break;
      case PT_FLOAT: pval->u_float = pv->u_float; break;
      case PT_DOUBLE: pval->u_double = pv->u_double; break;
      case PT_STRING: pval->u_string = pv->u_string; break;
      case PT_SELECT: pval->u_select = pv->u_select; break;
      case PT_INT3:
        for (int d = 0; d < 3; d++) {
      ...
      case PT_DOUBLE3:
        ...
        break;
      case PT_PTR: pval->u_ptr = pv->u_ptr; break;
      case PT_OBJ: pval->u_obj = pv->u_obj; break;
      case PT_FLOAT_ARRAY: {
        pval->u_float_array.nr_vals = pv->u_float_array.nr_vals;
        pval->u_float_array.vals =
          calloc(pval->u_float_array.nr_vals, sizeof(float));
        if (!pval->u_float_array.vals) {
          break;
        }
        for (int d = 0; d < pval->u_float_array.nr_vals; d++) {
...
int mrc_params_set_bool(void* p, struct param* params, const char* name,
                        bool val)
{
...
int mrc_params_set_string(void* p, struct param* params, const char* name,
                          const char* val)
{
  ...
  for (int i = 0; params[i].name; i++) {
    ...
    switch (params[i].type) {
      ...
      case PT_SELECT:
        ...
        mrc_params_get_option_select(params[i].name, params[i].u.select.descr,
                                     &pv->u_select);
        break;
      default: assert(0);
    }
...
void mrc_params_parse_nodefault(void* p, struct param* params,
                                const char* title, MPI_Comm comm)
{
  for (int i = 0; params[i].name; i++) {
    union param_u* pv = p + (unsigned long)params[i].var;
    switch (params[i].type) {
      ...
      case PT_STRING:
        ...
        break;
      case PT_SELECT:
        _mrc_params_get_option_select(params[i].name, params[i].u.select.descr,
                                      &pv->u_select, true, NULL);
        break;
      case PT_INT3:
      ...
      case PT_DOUBLE3:
        ...
        break;
      case PT_INT_ARRAY:
        _mrc_params_get_option_int_array(params[i].name, &pv->u_int_array, true,
                                         NULL);
        break;
      case PT_FLOAT_ARRAY:
        _mrc_params_get_option_float_array(params[i].name, &pv->u_float_array,
                                           true, NULL);
        break;
      case PT_PTR: break;
      case PT_OBJ:
  ...
  for (int i = 0; params[i].name; i++) {
    ...
    switch (params[i].type) {
      ...
      case PT_STRING:
        ...
        break;
      case PT_SELECT:
        mrc_params_get_option_select_help(name, params[i].u.select.descr,
                                          &pv->u_select, params[i].help);
        break;
      case PT_INT3:
        mrc_params_get_option_int3_help(name, &pv->u_int3[0], params[i].help);
        break;
      case PT_FLOAT3:
        mrc_params_get_option_float3_help(name, &pv->u_float3[0],
                                          params[i].help);
        break;
      case PT_DOUBLE3:
        mrc_params_get_option_double3_help(name, &pv->u_double3[0],
                                           params[i].help);
        break;
      case PT_INT_ARRAY:
        mrc_params_get_option_int_array_help(name, &pv->u_int_array,
                                             params[i].help);
        break;
      case PT_FLOAT_ARRAY:
        mrc_params_get_option_float_array_help(name, &pv->u_float_array,
                                               params[i].help);
        break;
      case PT_PTR:
      case PT_OBJ:
...
{
  union param_u* pv = (union param_u*)((char*)p + (unsigned long)prm->var);
  switch (prm->type) {
    case PT_INT:
    ...
    case PT_INT3:
      mrc_view_printf(comm, "%-20s| %d, %d, %d\n", prm->name, pv->u_int3[0],
                      pv->u_int3[1], pv->u_int3[2]);
      break;
    case PT_FLOAT3:
      mrc_view_printf(comm, "%-20s| %g, %g, %g\n", prm->name, pv->u_float3[0],
                      pv->u_float3[1], pv->u_float3[2]);
      break;
    case PT_DOUBLE3:
      mrc_view_printf(comm, "%-20s| %g, %g, %g\n", prm->name, pv->u_double3[0],
                      pv->u_double3[1], pv->u_double3[2]);
      break;
    case PT_INT_ARRAY: {
      char s[100], tmp[100];
