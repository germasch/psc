...
int main(int argc, char **argv)
{
  ...
  auto reader = io.open("flatfoil-summit121/bef-proc-68-time-1207.bp", kg::io::Mode::Read);
  //auto reader = io.open("bef-proc-0-time-0.bp", kg::io::Mode::Read);
  reader.get("d_mflds", d_mflds_1);
  reader.get("d_mprts", d_mprts_1);
  reader.close();

  auto reader2 = io.open("flatfoil-summit121/aft-proc-68-time-1207.bp", kg::io::Mode::Read);
  ...
  auto writer = io.open("flatfoil-summit121/after.bp", kg::io::Mode::Write, MPI_COMM_SELF);
